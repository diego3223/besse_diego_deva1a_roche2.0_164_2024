...
class FormWTFAjouterCotisations(FlaskForm):
    """
        Dans le formulaire "genres_ajouter_wtf.html" on impose que le champ soit rempli.
        Définition d'un "bouton" submit avec un libellé personnalisé.
    """
    nom_coti_regexp = "^([A-Z]|[a-zÀ-ÖØ-öø-ÿ])[A-Za-zÀ-ÖØ-öø-ÿ]*['\- ]?[A-Za-zÀ-ÖØ-öø-ÿ]+$"
    ...
    submit = SubmitField("Enregistrer cotisation")


class FormWTFUpdateCotisations(FlaskForm):
    """
...
class FormWTFDeleteCotisations(FlaskForm):
    """
